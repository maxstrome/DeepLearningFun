...
from DeepLearningFun.tensorflow_module.models.basic_cnn import basic_cnn_sequential, basic_cnn_functional, actual_cnn
import wandb
...
def train_basic_cnn(use_gpu: Optional[bool] = True) -> Tuple[keras.Model, TrainTestDatasetModel]:
    ...
    model = actual_cnn(input_size=input_size, num_labels=num_labels)
    model.compile(
        optimizer='adam',
